...
with st.echo(code_location='below'):
    ...
    left join (select uik, share from vybory_ful where umg_flg::numeric=1) as vyb using (uik)
    ...
    vybory_df_2['share']=vybory_df_2['share'].astype('float')
    """
    ...
    options = st.multiselect('Выберете факторы для модели:', ['Любимый ресторан', 'Промокоды', 'Количество машин'
        , 'Возраст', 'Год выпуска последнего автомобиля'], default='Возраст')
