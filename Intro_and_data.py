...
with st.echo(code_location='below'):
    ...
    **Для тех, кто на самом деле считает строки кода:** Во 1) вы душнила, во 2) кода в юпитере много
    , но я там не помечал заимстования, поэтому весь важный код оттуда будет здесь 
